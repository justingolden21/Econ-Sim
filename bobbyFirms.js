...
class Mine extends Firm {
	constructor(firmNum) {
		...
		this.buy = {'bread': 30}; //what it is buying, can be mutliple
		...
		this.producedGoods = {'ore': 30 + random(1,10)};//what this firm is producing
...
class Smith extends Firm {
	constructor(firmNum) {
		...
		/*in future there may be production substitutes, you can either have bread OR meat etc.
		That will make the supply curve smoother as well*/
		this.producedGoods = {'tools': 20 + random(1,10)};//what this firm is producing
...
class Forester extends Firm {
	constructor(firmNum) {
		...
		this.upkeep = { 'bread': 10, 'tools':1, 'interval': 5};
		/*it's upkeep fixed costs
		I changed upkeep to work exactly like the others, with an interval commented, so you can
		decide how to add it in */
		this.efficiency = normal(-2,2);// a random stand in for the 'talent' of the firm
		...
		/*in future there may be production substitutes, you can either have bread OR meat etc.
		That will make the supply curve smoother as well*/
		this.producedGoods = {'lumber': 10 + random(1,5)};//what this firm is producing
...
class Farm extends Firm {
	constructor(firmNum) {
		...
		/*in future there may be production substitutes, you can either have bread OR meat etc.
		That will make the supply curve smoother as well*/
		this.producedGoods = {'wheat': 300 + random(1,100)};//what this firm is producing
...
class Mill extends Firm {
	constructor(firmNum) {
		...
		/*in future there may be production substitutes, you can either have bread OR meat etc.
		That will make the supply curve smoother as well*/
		// this.producedGoods = {'flour': 200 + random(1,50)};//what this firm is producing
		this.producedGoods = {'wheat': 200 + random(1,50)};//what this firm is producing
